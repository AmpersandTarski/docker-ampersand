 ...
 * RAP3 settings
 *************************************************************************************************/
Config::set('ampersand', 'RAP3', '/usr/local/bin/ampersand');
 ...
 * DATABASE settings
 *************************************************************************************************/
// Before deployment test: uncomment the lines below, AND replace the variables rap3, {SQLPW}, {SQLDB}, {SQLHOST} with appropriate values
Config::set('dbUser', 'mysqlDatabase', 'rap3');     // typically: 'ampersand'
Config::set('dbPassword', 'mysqlDatabase', 'rap3');   // typically: 'ampersand'
Config::set('dbName', 'mysqlDatabase', 'ampersand_rap3');       // typically: '' or 'ampersand_rap3'
